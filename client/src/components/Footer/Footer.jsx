  ...
  return (
    <div className=" pt-16 pb-4">
      <div className="flex lg:flex-row flex-col justify-evenly">
        <div className="flex mb-8 items-center  justify-center gap-x-2">
        ...
        <div className="flex lg:flex-row lg:w-1/2 justify-around  items-center lg:p-0  p-4">
          ...
          <div className="text-white">
            <h1 className="lg:text-3xl text-2xl font-bold font-instagram mb-4">Location</h1>
            <div className="border-2 border-white lg:w-[250px] h-[130px] ">
              <iframe
