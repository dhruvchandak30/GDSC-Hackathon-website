...
const Footer = () => {
  ...
  <div className='pt-16 pb-4'>
      <div className='flex justify-around'>
        <div className='flex items-center gap-x-2'>
            <div className='text-white'>
                ...
                <h1 className='font-pricedown text-5xl'>codex <span className='text-xl'>1.0</span></h1>
        ...
        <h1 className='text-3xl font-bold mb-4'>Location</h1>
            <div className='border-2 border-white w-[250px] h-[150px]'>
    ...
    <div className='border-2 border-[#FFFFFF80] w-[75%] mx-auto mt-10'>
